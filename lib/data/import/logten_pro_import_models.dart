...
extension LogTenFieldAssociationLabel on LogTenFieldAssociation {
  ...
  String get label {
    return switch (this) {
      ...
      LogTenFieldAssociation.route => 'Route (Departure / Arrival)',
      ...
      LogTenFieldAssociation.ifrTime => 'Instrument Time',
...
Map<String, LogTenFieldAssociation> buildDefaultLogTenAssignments(
  ...
  for (final column in columns) {
    result[column] = switch (column) {
      ...
      // Pro Flight Logbook CSV export.
      'DATE' => LogTenFieldAssociation.date,
      'AIRCRAFT MAKE & MODEL' => LogTenFieldAssociation.aircraftTypeCode,
      'AIRCRAFT IDENT' => LogTenFieldAssociation.registration,
      'ROUTE OF FLIGHT' => LogTenFieldAssociation.route,
      'DURATION' => LogTenFieldAssociation.totalTime,
      'LANDINGS DAY' => LogTenFieldAssociation.dayLandings,
      'LANDINGS NIGHT' => LogTenFieldAssociation.nightLandings,
      'INSTRUMENT' => LogTenFieldAssociation.ifrTime,
      'NIGHT' => LogTenFieldAssociation.nightTime,
      'SIMULATOR' => LogTenFieldAssociation.simulatorTime,
      'CROSS COUNTRY' => LogTenFieldAssociation.crossCountryTime,
      'SOLO' => LogTenFieldAssociation.soloTime,
      'PILOT IN COMMAND' => LogTenFieldAssociation.picTime,
      'SECOND IN COMMAND' => LogTenFieldAssociation.sicTime,
      'DUAL' => LogTenFieldAssociation.dualReceivedTime,
      'INSTRUCTOR' => LogTenFieldAssociation.dualGivenTime,
      'REMARKS' => LogTenFieldAssociation.remarks,
