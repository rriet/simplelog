...
class LogTenProImportReviewDialog extends ConsumerStatefulWidget {
  ...
  static Future<LogTenImportReviewResult?> show(
    ...
    return showDialog<LogTenImportReviewResult>(
      ...
      builder: (context) =>
          LogTenProImportReviewDialog(issues: issues, options: options),
    );
  }
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    const Expanded(
                      child: Text(
                        'Fix the value for each invalid field, or ignore the '
                        'full source line.',
                      ),
                    ),
                    TextButton(
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final supportsSimulatorChoice =
                        _lineSupportsSimulatorChoice(
                          lineIssues,
                        );
                    final simulatorSelected = _simulatorLines.contains(
                      lineNumber,
                    );
                          ...
                          children: [
                            ...
                            if (supportsSimulatorChoice) ...[
                              ...
                              if (simulatorSelected)
                                const Text(
                                  'Simulator selected: airport fields are '
                                  'not required.',
                                ),
